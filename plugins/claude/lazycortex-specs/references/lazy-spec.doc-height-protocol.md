...
Contract for every expert dispatched against a document of the `vision`, `system-vision`, `system-design`, `system-tech`, `system-ui-design`, `system-use-cases`, or `design` review class — the main writer and every validator alike. It governs one thing: at what level of abstraction this document speaks, and what to do with material that belongs a level below.
