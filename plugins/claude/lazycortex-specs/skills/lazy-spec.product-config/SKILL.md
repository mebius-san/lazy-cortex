...
| `system-use-cases` | `["*/use-cases.md"]` | `[{ "name": "<use-case-writer>" }, { "name": "<editor>" }]` | D | `context_from_frontmatter: [spec_source_requests]` |
...
| `system-use-cases@<key>` | `["<spec_path>/use-cases.md"]` | `[{ "name": "<use-case-writer>" }, { "name": "<editor>" }]` | D |
