...
**Symptom**: `/lazy-observe.install` completes, but its Step 10.5 line reports outcome `skipped-no-grafana`, and the dashboards under `plugins/claude/lazycortex-observe/dashboards/` never appear in your Grafana instance's dashboard list without a manual import.
