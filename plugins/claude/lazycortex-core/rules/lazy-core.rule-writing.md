...
`lazy-core.audit` Agent B runs the checks above on `.claude/rules/*.md`, `~/.claude/rules/*.md`, and `plugins/claude/*/rules/*.md`. `lazy-core.doctor` Phase 3 surfaces the findings and prompts for fixes.
