...
- Contract source of truth: `plugins/claude/lazycortex-core/references/lazy-core.expert-protocols-contract.md`. The clauses above mirror that contract; consult it for the standard job-dir layout (request.json, READY, source/, context/, result/, response.json, DONE).
-->
