...
```
Skill(skill: "lazycortex-core:lazy-routine.register", args: "name=<name> <cfg keys> --managed type,watch,command,expert,request,path_filter,git_author")
```
