...
generated_at: 2026-09-03 18:40:32 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-obsidian — up to date

**Status**: published — version `5.0.3` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-obsidian/` since.
