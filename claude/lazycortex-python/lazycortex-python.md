...
generated_at: 2026-07-28 15:33:19 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-python — up to date

**Status**: published — version `2.0.9` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-python/` since.
