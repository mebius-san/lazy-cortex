...
- **Marker comment system.** `TODO:`, `TMP:`, `DBG:`, `ref:`, `opt:`, `guard:`, `limit:`, `Decision:`, `Domain(…):`, `# Contract:`, `# waiver:` are project-wide conventions imported with the rules. Treat them as human-readable annotations; no extraction tooling currently ships with this plugin.
