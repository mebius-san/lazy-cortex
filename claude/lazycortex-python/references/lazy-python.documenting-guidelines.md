---
description: Docstring rules (class, method, property) with their pattern galleries, for Python projects that adopt these conventions.
---
# Documentation Standards

Docstring rules (class, method, property) with their pattern galleries, for
Python projects that adopt these conventions. Comments — purpose comments and
guard clauses, marker comments, contract comments, and Domain comments — live
in the sibling `lazy-python.comment-guidelines.md`.
...
- `TODO:`, `TMP:`, `DBG:`, `ref:`, `opt:`, `guard:`, `limit:`, `Decision:`, `Domain(…):` and other special comments interpretation rules:
  ...
  - Treat `opt:` comments as optimization annotations naming the assumption a performance-driven choice rests on. Never carry that assumption into the docstring — document what the code does, not what its cache relies on. Do not alter or remove them.
