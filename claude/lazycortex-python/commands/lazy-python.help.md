...
- [add-project-overlay](https://github.com/mebius-san/lazy-cortex/blob/main/claude/lazycortex-python/help/walkthroughs/add-project-overlay.md) — Register project-specific docstring sections and a private-attribute escape hatch in pyproject.toml, then write their content rules in the overlay so lazy-python.docstring-writer honours them.
- [install-and-first-check](https://github.com/mebius-san/lazy-cortex/blob/main/claude/lazycortex-python/help/walkthroughs/install-and-first-check.md) — Install lazycortex-python, then run chk-py all -q directly to build the project venv and prove the six-step gate is clean.
