...
generated_at: 2026-06-11 09:30:00 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-wiki — up to date

**Status**: published — version `1.5.0` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-wiki/` since.
