...
surface_sha: 9641944b00a4bb1f8a66a25a18a5fa8583e841a2616bd878aa2cf4c20691fb2f
---
...
**Waking up a scope the audit flagged `scope-self-nullified`** — run `/lazy-wiki.configure` against that scope id and narrow or drop the `exclude_paths` glob the finding named; the finding's file count tells you how many nodes you're about to wake into curation before you make the change.
