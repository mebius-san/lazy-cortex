---
description: Shared logging-waiver classification heuristic for lazy-core.install and lazy-core.audit — the candidate classes and suggested waiver-reason templates, kept as one source of truth.
---
# Logging-Waiver Candidate Heuristic

Shared classification rules for `lazy-core.install` and `lazy-core.audit` (the logging checks absorbed from the retired lazycortex-log plugin). One source of truth.
