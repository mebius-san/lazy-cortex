...
published_version: 9.2.0
generated_at: 2026-09-07 19:30:11 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-core — up to date

**Status**: published — version `9.2.0` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-core/` since.
