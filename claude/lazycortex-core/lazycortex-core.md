...
generated_at: 2026-06-24 18:44:11 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-core — up to date

**Status**: published — version `5.5.0` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-core/` since.
