...
generated_at: 2026-09-05 16:45:34 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-review — up to date

**Status**: published — version `6.3.1` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-review/` since.
