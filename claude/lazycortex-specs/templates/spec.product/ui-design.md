...
product: {{product}}
spec_role: ui-design
spec_doc_type: system-ui-design
wiki_pinned_topics:
  - wiki/doc-kind/ui-design
...
## Screen patterns
<!-- Recurring screen shapes — list, detail, form, wizard, dashboard, empty and error states — each named once here so an asset's ui-design references the pattern rather than redraws it. -->

## Navigation
<!-- The navigation skeleton: top-level areas, how a user moves between them, and where an asset's screens attach to it. -->
