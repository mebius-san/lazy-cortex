...
```
Bash(lazycortex-specs request-draft --source <the re-approved document> --title <one line naming the divergence> --body <a file holding the candidate's prose>)
```
