...
- `spec.add-asset-category` — Register an operator-defined asset category on a product (icon + folder-note); review coverage is inherited from the shared behavior-keyed classes.
