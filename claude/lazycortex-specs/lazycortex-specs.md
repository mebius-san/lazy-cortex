...
generated_at: 2026-09-05 22:25:16 UTC
iconize_icon: LiFileClock
iconize_color: "#86efac"
---
# lazycortex-specs — up to date

**Status**: published — version `7.3.1` matches the top of `CHANGELOG.public.md` and no commits have landed under `claude/lazycortex-specs/` since.
