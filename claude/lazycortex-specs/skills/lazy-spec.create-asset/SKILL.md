...
- **`vision`** — fill `vision.md`'s sections (Overview / Goals / Value Proposition / Design Concept / Risks) from the clarification: the asset's goals live ONLY here; the Design Concept is one paragraph plus a reference to the sibling design, never a digest of it.
