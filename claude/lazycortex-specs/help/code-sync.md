...
diagram_spec:
  ...
  request: "Decision-tree showing when to reach for lazy-spec.sync-with-code vs lazy-spec.rebase-pins vs lazy-spec.coverage — inputs are 'code changed since last sync', 'branch just merged or deleted', and 'looking for capabilities the spec tree never documented'; outputs are tech-doc updates, gate proposals, pin rewrites, spec_released proposals, and gap-candidate reports with proposed category+slug."
source_skills:
