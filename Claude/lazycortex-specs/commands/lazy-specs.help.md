...
No skills, agents, or commands ship yet. This plugin is a placeholder for future spec-authoring and design-review tooling.

See `README.md` in the plugin for current status.
