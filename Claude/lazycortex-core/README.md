...
| `lazy-core.install` | Bootstrap the lazycortex-core plugin for the current project (or globally). Copies the hygiene and security rule templates into the rules directory. Idempotent — safe to re-run. Detects install scope automatically. |
